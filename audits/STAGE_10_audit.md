# Audit report — Stage 10

**Date**: 2026-06-13T18:18:05Z
**Task doc**: tasks/STAGE_10_explainability.md
**Baseline**: 383
**Audit total**: 364
...
```
Audit report (2026-06-13T18:18:01Z)
=============================================
  mock_predictions                  0
...
---------------------------------------------
  TOTAL                           364
---------------------------------------------
Baseline (from .audit-baseline): 383
OK: count decreased from 383 to 364.
```

Gate: total (364) must be **<=** baseline (383). Strictly **<** unless stage is flagged `--no-baseline-drop`.
