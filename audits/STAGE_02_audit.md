# Audit report — Stage 02

**Date**: 2026-05-24T12:19:46Z
**Task doc**: tasks/STAGE_02_simpy_simulator.md
**Baseline**: 439
**Audit total**: 436
...
```
Audit report (2026-05-24T12:19:43Z)
=============================================
  mock_predictions                  3
...
---------------------------------------------
  TOTAL                           436
---------------------------------------------
Baseline (from .audit-baseline): 439
OK: count decreased from 439 to 436.
```

Gate: total (436) must be **<=** baseline (439). Strictly **<** unless stage is flagged `--no-baseline-drop`.
