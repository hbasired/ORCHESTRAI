# Audit report — Stage 14

**Date**: 2026-06-20T06:43:41Z
**Task doc**: tasks/STAGE_14_a2a_protocol.md
**Baseline**: 364
**Audit total**: 364
...
```
Audit report (2026-06-20T06:43:37Z)
=============================================
  mock_predictions                  0
...
- [x] Audit count flat at 364. WAIVED via `--no-baseline-drop` — justified in `knowledge-base/KB_TASK_LOG.md` (Stage 14 entry): the A2A surface (`backend/a2a/`) is real ML-DSA-65-signed agent cards + JSON-RPC 2.0 dispatch + a real exposed capability (forecast_oee) — no `random.*`/mock/classical-crypto theatre the grep counts; new code is additive. ADR `2026-06-15_stage14_a2a_protocol.md`.
